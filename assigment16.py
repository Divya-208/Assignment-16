...
db=py.connect("localhost","root","Divya208","Book")
...
cursor.execute("insert into publishers values(001,'abc','Bombay',10002,11001)")
...
cursor.execute("insert into authors values(001,'Divya','null','red')")
...
result=cursor.fetchall()
print(result)
cursor.execute("update book set genre='love story' where book_id=201")
cursor.execute("select * from book")
result=cursor.fetchall()
print(result)
db.commit()
